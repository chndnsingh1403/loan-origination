...
type TabType = 'summary' | 'documents' | 'tasks' | 'exceptions' | 'timeline' | 'notes';
...
export default function ApplicationDashboard() {
  ...
  const fetchApplication = async () => {
    try {
      const res = await authenticatedFetch(`/api/broker/applications/${id}`);
      if (res.ok) {
            ...
            <div className="divide-y">
              {tasks.length === 0 ? (
                <div className="p-8 text-center text-gray-500">
                  No tasks yet. Tasks will appear here as the application progresses.
                </div>
              ) : (
                tasks.map((task) => (
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div className="pb-8">
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    Initial application submitted by broker
                  </div>
                </div>
              </div>
              ...
              {application.submitted_at && (
                <div className="flex gap-4">
                  ...
                  <div className="pb-8">
                    ...
                    <div className="text-sm text-gray-500 mt-1">
                      Application moved to underwriting
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="flex gap-4">
                ...
                <div className="text-gray-400">
                  <div className="font-medium">Awaiting next step...</div>
                </div>
              </div>
            </div>
          </div>
