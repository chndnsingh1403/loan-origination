...
-- ===================== Integration & Workflow Foundation (Phase 1) =====================
...
-- Comments for integration tables
COMMENT ON TABLE integration_configs IS 'Tenant-specific configuration for external integration providers';
COMMENT ON TABLE integration_results IS 'Log of all integration API calls and their results';
COMMENT ON TABLE data_enrichments IS 'Track all data enrichments applied to applications from external sources';
COMMENT ON TABLE organization_workflows IS 'Custom n8n workflows per tenant organization';
COMMENT ON TABLE workflow_executions IS 'Execution history of workflow runs';
COMMENT ON TABLE webhook_logs IS 'Log of all webhook calls for debugging and monitoring';
